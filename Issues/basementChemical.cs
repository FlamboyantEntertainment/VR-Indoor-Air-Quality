...
public class basementChemical : MonoBehaviour {
    ...
    void Awake () {
        chemicalText = GameObject.Find("basement_asbestos");
        chemicalCompleted = GameObject.Find("Basement_chemical_hazard_completed");
