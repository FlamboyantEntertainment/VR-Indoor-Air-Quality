...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectSlider : MonoBehaviour
    {
        ...
        [SerializeField] private float m_Duration = 1f;                     // The length of time it takes for the bar to fill.
        ...
        [SerializeField] private SelectRadial m_SelectionRadial;         // Optional reference to the SelectionRadial, if non-null the duration of the SelectionRadial will be used instead.
